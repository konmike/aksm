(function($) {
    ...
    $('.item-hover-88 .info').append('<span class="prepare-fake">Připravujeme</span>');
    $('.section--introduction').append('<a href="/?page_id=8" class="link link--more-info">Více</a>');
    ...
    if ( allLis.length > 10 ){
        ...
        for (let i = 0; i < countUl; i++) {
            if (i === 0)
                ...
                ul = $('<ul>',{id:"list-part" + i, class:"list list--part", style:"display:none"});
        ...
        $('.section--splitter').append('<div class="controls"><a href="#" id="prev">Předchozí</a><a href="#" id="next">Další</a></div>');
        ...
        $('.section--splitter').css({'display':'grid','grid-template-columns':'1fr 1fr','justify-items':'center','align-items':'baseline'})
    }
