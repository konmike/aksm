	...
	<table class="wpos-plugin-pricing-table">
	    ...
	    <thead>
	    	<tr>
	    		...
	    		<th>
	    			<h2>Premium</h2>
	    			<p>Gain access to <strong>Timeline and History slider</strong> included in <br /><strong>Essential Plugin Bundle</p>
	    ...
	    <tfoot>
	    	<tr>
	    		<th></th>
	    		<td></td>
	    		<td><p>Gain access to <strong>Timeline and History slider</strong> included in <br /><strong>Essential Plugin Bundle</p>
	     ...
	     <tbody>
			...
			<tr>
	    		<th>Visual Composer/WPBakery Page Builder Supports <span>Use this plugin with Visual Composer OR WPBakery page builder easily</span></th>
	    		<td><i class="dashicons dashicons-no-alt"></i></td>
	    		<td><i class="dashicons dashicons-yes"></i></td>
	    	</tr>
	    	<tr>
